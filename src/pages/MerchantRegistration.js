...
first_name: Yup.string()
  .min(3, 'First Name Must be 3 to 35 characters')
...
user_name: Yup.string()
  .min(5, 'User Name must between 5 to 25 characters')
...
export const MerchantRegistration = props => (
  <Formik
    ...
    onSubmit={values => {
      fetch('http://10.0.2.2:8000/api/user/registration/', {
          method: 'POST',
          headers: {
