...
const CustomButton = (props) => {
  return (
    <View style={[atomicStyles.buttonContainer, props.style]}>
      <TouchableOpacity
...
const CustomButton2 = (props) => {
  return (
    <View style={atomicStyles.buttonContainer}>
      <TouchableOpacity onPress={props.onPress} style={props.style}>
        <Text style={styles.customButtonText2}>{props.title}</Text>
      </TouchableOpacity>
    </View>
  );
};
...
const CustomButton3 = (props) => {
  return (
    <View style={atomicStyles.buttonContainer}>
      ...
      >
        <Text style={styles.customButtonText3}>{props.title}</Text>
      </TouchableOpacity>
    </View>
  );
};
